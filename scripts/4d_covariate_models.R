...
make_input_folder_cont(df, mb, "FramRisk", "framingham")
...
make_input_folder_bin(df, mb, "HT", "hypertension")
make_input_folder_bin(df, mb, "DM", "diabetes")
make_input_folder_bin(df, mb, "Hyperchol", "hyperchol")
